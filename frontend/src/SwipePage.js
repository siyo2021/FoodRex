	...
	return (
		<PageWrapper>
			...
			<Box width="100%" mb="33px">
				...
				<Box bg="gray.300" mb={30} w="500px" borderBottomRadius="md" p="3" fontSize="md" margin="auto">
					<Flex justifyContent="spaceBetween">
						<Text>Placeholder text</Text>
						<Image src="../arrow.png" alt="An arrow pointing downwards" boxSize="8" ml="auto" mr="0"/>
					</Flex>
				</Box>
			</Box>
			<Box width="100%" textAlign="center">
				...
				<Button borderRadius="full" h="120px" w="120px" bg="#f59681" ml="63px">
					<Image src={dislike} alt="Dislike" boxSize="90px" m={2} p={2} />
				</Button>
				<Spacer />
				<Button borderRadius="full" h="120px" w="120px" bg="#89c58b" mr="63px">
